...
hold on;
hhh2=plot(0,0,'rx','erasemode','xor','MarkerSize',12) ;  % landmarks centers
hhh3=plot(0,0,'g.','erasemode','xor') ;   % approx. landm. circles
legend('unclassified blips','mean landmark','est landmark')
axis([-50,50,0,75]);
hold off ;
...
writerObj = VideoWriter('victoriaParkDataset.avi');
