...
a Python wrapper for a fast solver generated by FORCESPRO v4.2.0
   ...
   subject to the parameters supplied in the following dictionary:
       PARAMS['x0'] - column vector of length 350
   ...
   OUTPUT returns the values of the last iteration of the solver where
       ...
       OUTPUT['x31'] - column vector of size 7
       OUTPUT['x32'] - column vector of size 7
       OUTPUT['x33'] - column vector of size 7
       OUTPUT['x34'] - column vector of size 7
       OUTPUT['x35'] - column vector of size 7
       OUTPUT['x36'] - column vector of size 7
       OUTPUT['x37'] - column vector of size 7
       OUTPUT['x38'] - column vector of size 7
       OUTPUT['x39'] - column vector of size 7
       OUTPUT['x40'] - column vector of size 7
       OUTPUT['x41'] - column vector of size 7
       OUTPUT['x42'] - column vector of size 7
       OUTPUT['x43'] - column vector of size 7
       OUTPUT['x44'] - column vector of size 7
       OUTPUT['x45'] - column vector of size 7
       OUTPUT['x46'] - column vector of size 7
       OUTPUT['x47'] - column vector of size 7
       OUTPUT['x48'] - column vector of size 7
       OUTPUT['x49'] - column vector of size 7
       OUTPUT['x50'] - column vector of size 7
...
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 350),
...
('x31', ctypes.c_double * 7),
('x32', ctypes.c_double * 7),
('x33', ctypes.c_double * 7),
('x34', ctypes.c_double * 7),
('x35', ctypes.c_double * 7),
('x36', ctypes.c_double * 7),
('x37', ctypes.c_double * 7),
('x38', ctypes.c_double * 7),
('x39', ctypes.c_double * 7),
('x40', ctypes.c_double * 7),
('x41', ctypes.c_double * 7),
('x42', ctypes.c_double * 7),
('x43', ctypes.c_double * 7),
('x44', ctypes.c_double * 7),
('x45', ctypes.c_double * 7),
('x46', ctypes.c_double * 7),
('x47', ctypes.c_double * 7),
('x48', ctypes.c_double * 7),
('x49', ctypes.c_double * 7),
('x50', ctypes.c_double * 7),
]
