...
controller.LookaheadDistance = 6;  %1 for my track
controller.Wb = 2.9;
...
while(1)
    ...
    [v,w, lookaheadPoint, a] = next_step(controller, RobotEstimatedPose([1 2 3]));
...
writerObj = VideoWriter('LOSHandlingTrack.avi');
